        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDUtenteAssociato = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarrelloProdotti", x => x.IDCarrello);
                });
            ...
            migrationBuilder.CreateTable(
                name: "DettagliCarrello",
                columns: table => new
                {
                    IDProdottoClonato = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Immagine = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Nome = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Descrizione = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Prezzo = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    QuantitaOrdinati = table.Column<int>(type: "int", nullable: false),
                    Categoria = table.Column<int>(type: "int", nullable: false),
                    Taglia = table.Column<int>(type: "int", nullable: false),
                    Colore = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IDCarrelloAssociato = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DettagliCarrello", x => x.IDProdottoClonato);
                    table.ForeignKey(
                        name: "FK_DettagliCarrello_CarrelloProdotti_IDCarrelloAssociato",
                        column: x => x.IDCarrelloAssociato,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DettagliCarrello_IDCarrelloAssociato",
                table: "DettagliCarrello",
                column: "IDCarrelloAssociato");
        }
